...
#Pengiraan Sudut Rashdul Kiblat
rk = 360-arahkiblat
rk1= math.tan(math.radians(rk))*math.sin(math.radians(latitudtempatatan))
u1=math.atan(rk1)
u = math.degrees(math.pi/2-abs(math.atan(rk1)))
tu1 = math.tan(math.radians(latitudkaabah))*math.cos(math.radians(u))/math.tan(math.radians(latitudtempatatan))
tu = math.degrees(math.acos(tu1))
sudutwaktuarahkiblat = (tu-abs(u))/15
wakturashdulkiblat = sudutwaktuarahkiblat+waktuistiwa
wakturashdulkiblatdegree = int(wakturashdulkiblat)
temp1 = 60 * (wakturashdulkiblat - wakturashdulkiblatdegree)
wakturashdulkiblatminute = int(temp1)
wakturashdulkiblatsaat = 60 * (temp1 - wakturashdulkiblatminute)
print('')
print('Bayang Matahari akan mengharap ke kiblat pada jam')
print(wakturashdulkiblatdegree,wakturashdulkiblatminute,wakturashdulkiblatsaat)